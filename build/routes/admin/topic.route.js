...
router.post("/create", upload.single("imgTopic"), uploadSingle, controller.createTopic);
router.get("/edit/:id", controller.getEditTopicPage);
router.patch("/edit/:id", upload.single("imgTopic"), uploadSingle, controller.editTopic);
